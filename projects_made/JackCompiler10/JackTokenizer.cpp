...
string JackTokenizer::toString() {
    string ret;
    if (tokenType == KEYWORD) {
        ret =  "LLLLL keyword : " + keyword;
    } else if (tokenType == SYMBOL) {
        ret =  "LLLLL symbol : " + symbol;
    } else if (tokenType == IDENTIFIER) {
        ret =  "LLLLL identifier : " + identifier;
    } else if (tokenType == INT_CONST) {
        ret =  "LLLLL int_const : " + to_string(intVal);
    } else if (tokenType == STRING_CONST) {
        ret = "LLLLL string_const : " + stringVal;
    } else {
        ret = "LLLLL empty : ";
    }
    return ret;
